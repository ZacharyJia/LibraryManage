...
<?php include('nav.php'); ?>
<div class="col-sm-12">
    <form class="form-horizontal" action="infoSave" method="post">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-7">
                <input type="text" disabled="disabled" class="form-control" id="card-name" name="card-name" placeholder="证件类型" value="<?php echo $reader['card-name'] ?>">
            </div>
        </div>
        <div class="form-group">
            <label for="card-id" class="col-sm-2 control-label">证件号码</label>
            <div class="col-sm-7">
                <input type="text" disabled="disabled" class="form-control" id="card-id" name="card-id" placeholder="证件号码" value="<?php echo $reader['card-id'] ?>">
            </div>
        </div>
        <div class="form-group">
            <label for="level" class="col-sm-2 control-label">读者等级</label>
            <div class="col-sm-7">
                <select id="level" disabled="disabled">
                    <?php
        ...
        <div class="form-group">
            ...
            <div class="col-sm-7">
                <input type="text" class="form-control" id="username" disabled="disabled" placeholder="用户名"  value="<?php echo $user['username'] ?>">
            </div>
        </div>
        <div class="form-group">
